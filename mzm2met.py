...
Example usage: (`mzm.in` and `mzm-eur.in`)
```bash
python3 mzm2met.py \
    mzm.in \
    ...
    met.out
```
Example usage: (`mzm-jp.in`)
```bash
python3 mzm2met.py \
    mzm-jp.in \
      0x07dd1c0:0x00000-0x1ffff` : \
    `+0x07f6ff8:0x04d60-0x0515f` : \
    `+0x07f4a88:0x05160-0x0555f` : \
    `+0x07f47a0:0x08d60-0x0915f` : \
    `+0x07f54ac:0x09160-0x0955f` : \
    `+0x07f4de8:0x0cd60-0x0d15f` : \
    `+0x07f5178:0x0d160-0x0d55f` : \
    `+0x07f44a8:0x10d60-0x1127f` : \
    `+0x07f62c8:0x11360-0x1155f` : \
    `+0x07f69c0:0x14d60-0x151af` : \
    `+0x07f3c68:0x18000-0x1899f` : \
    `+0x07f75a4:0x189a0-0x18a9f` : \
    `+0x07f7288:0x18be0-0x190df` : \
    `+0x07f365c:0x190e0-0x1988f` : \
    `+0x07f7278:0x19890-0x1989f` : \
    `+0x07f77a4:0x19980-0x199bf` : \
    `+0x07f7658:0x19da0-0x19eef` : \
    `+0x07f5cec:0x19ef0-0x1a6ef` : \
    `+0x07f6780:0x1a6f0-0x1a94f` : \
    `+0x07f6d78:0x1a950-0x1a9bf` : \
    `+0x07f64c8:0x1a9c0-0x1ac9f` : \
    `+0x07f57d4:0x1aca0-0x1b29f` : \
    `+0x07f5c5c:0x1b2a0-0x1b32f` : \
    `+0x07f6414:0x1b330-0x1b3ef` : \
    `+0x07f6208:0x1b3f0-0x1b4af` : \
    `+0x07f6df4:0x1b4c0-0x1b8bf \
    met-jp.out
```
MZM versions this was developed for:
```
...
8.0M mzm-jp.in crc32:44b79e2b md5:650140ccae6e1ab7af44c74986002375 sha1:096f07685a3dc9286e71aa0b761f233b5efa2fcd sha256:d087ca6e2d1808109a579c2283e944d81c8426d37de564f99ea9273087c2172a size:8388608
```
"""
